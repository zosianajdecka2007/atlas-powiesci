...
create table public.relationships (
  ...
  jealousy_level integer check (jealousy_level between 1 and 10),
  safety_level integer check (safety_level between 1 and 10),
  dependency_level integer check (dependency_level between 1 and 10),
  obsession_level integer check (obsession_level between 1 and 10),
  power_dynamic text default '',
  description text default '',
  secrets text default '',
  notes text default '',
  important_scenes text default '',
